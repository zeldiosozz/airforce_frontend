...
export default function Footer({ onShopClick, onAboutClick, onContactClick }: FooterProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-900">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <p className="text-xs text-slate-400 font-sans font-light leading-relaxed max-w-sm">
              Airforce-based premium designer footwear studios. We merge athletic biomechanics and advanced carbon fiber plate technology to manufacture sneakers with unprecedented comfort and kinetic spring.
            </p>

            {/* Socials */}
            <div className="flex items-center gap-3">
              {[
                { icon: Instagram, link: "https://www.instagram.com/airforce_store200", title: "Instagram" },
                { icon: Facebook, link: "https://www.facebook.com/share/1JwVU2tdod/", title: "Facebook" },
              ].map((social, idx) => {
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2 text-xs text-slate-400 font-sans font-light">
              <li>
                <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-orange-500 transition-colors">
                  Size Guide & Fitting
                </a>
              </li>
              <li>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-slate-400 font-sans font-light">
              <li className="flex gap-2.5 items-start">
                ...
                <span>AirForce Labs, Marine Drive, Kochi, Airforce, PIN 682031</span>
              </li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-500 gap-4">
          <div className="flex items-center gap-1 font-sans">
            <span>&copy; {new Date().getFullYear()} AirForce Footwear Private Ltd. All Rights Reserved.</span>
          </div>
          <div className="flex items-center gap-1 font-sans font-light">
            <span>Handcrafted with</span>
            <Heart size={10} className="text-red-500 fill-red-500" />
            <span>in Airforce, Egypt.</span>
          </div>
        </div>
