...
export default function Newsletter() {
  ...
  return (
    <section id="newsletter-section" className="py-20 bg-white">
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center space-y-8">
            <div className="space-y-3">
              ...
              <p className="text-xs sm:text-sm text-slate-400 max-w-md mx-auto font-sans font-light leading-relaxed">
                Join the ShoeSpike newsletter to receive early-access product drops, elite training guides, and private discount vouchers.
              </p>
            </div>
            ...
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                >
                  ...
                  <h4 className="text-white font-semibold font-display text-sm">Welcome to the Club!</h4>
                  <p className="text-xs text-slate-300 font-light text-center">
                    Check your inbox for your **15% discount code** and early access details.
                  </p>
                  <button
                ...
                >
                  <div className={`flex flex-col sm:flex-row gap-3 p-1.5 bg-slate-800/80 border rounded-2xl shadow-inner transition-all ${
                    isError ? "border-red-500 ring-2 ring-red-500/20" : "border-slate-700/80 focus-within:border-orange-500 focus-within:ring-2 focus-within:ring-orange-500/20"
                  }`}>
            ...
            {/* Subtle privacy fineprint */}
            <span className="text-[9px] text-slate-500 block">
              We respect your privacy. Unsubscribe any time. No spam, guaranteed.
            </span>
          </div>
